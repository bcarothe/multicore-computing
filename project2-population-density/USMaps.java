...
public class USMaps {
	...
	public static void main(final String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				// Display early because the wait for something to appear on-screen is
				// unsettling
	...
	public static void pqPreprocess() {
		PopulationQuery.preprocess(FILENAME, mapPane.getColumns(), mapPane.getRows(), getVersionNum());
	}
}
