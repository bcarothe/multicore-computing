...
public class Rectangle {
	...
	// move up/right)
	// note in our census data longitude "West" is a negative number which nicely
	// matches bigger-to-the-right
	public float left;
	public float right;
	public float top;
	public float bottom;
	...
	public Rectangle encompass(Rectangle that) {
		return new Rectangle(Math.min(this.left, that.left), Math.max(this.right, that.right),
