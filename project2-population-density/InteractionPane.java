...
public class InteractionPane extends JComponent {
		...
		numRowsEditorField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(appFrame, "Must enter a number in the \"Number of Rows\" field.",
		...
		numColumnsEditorField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(appFrame, "Must enter a number in the \"Number of Columns\" field.",
							"Number Entry Error", JOptionPane.ERROR_MESSAGE);
					return;
				}
				...
				if (!s.equals(text)) {
					...
					try {
						...
						JOptionPane.showMessageDialog(appFrame,
								"Must enter a number in the \"Number of Columns\" field.", "Number Entry Error",
	...
	public void selectButton(int i) {
		switch (i) {
			case 1:
				versionRadios.setSelected(v1Radio.getModel(), true);
				break;
			case 2:
				versionRadios.setSelected(v2Radio.getModel(), true);
				break;
			case 3:
				versionRadios.setSelected(v3Radio.getModel(), true);
				break;
			case 4:
				versionRadios.setSelected(v4Radio.getModel(), true);
				break;
			case 5:
				versionRadios.setSelected(v5Radio.getModel(), true);
				break;
			default:
				break;
		}
